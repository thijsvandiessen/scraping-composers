...
CLAIMS_SYSTEM_PROMPT = (
    ...
    "the page names it), the kind of subject ('person', 'work', 'ensemble', 'place', or "
    "'publisher'), and a predicate. Put the stated value in 'value' when it is a literal such as "
    "a date, a number, or a text. When the object is itself a named thing, leave 'value' null and "
    "give 'object_kind' ('work', 'person', 'place', 'profession', 'genre', 'ensemble', "
    "'publisher', 'instrumentation') with 'object_label' instead.\n\n"
    ...
    "A sheet-music, score or catalogue page states facts about the piece and facts about the "
    "printed edition of it — who edited it, who provided the fingering, who published it, what "
    "kind of edition it is, its catalogue or order number, its ISMN. Record all of them, with the "
    "piece as the subject.\n\n"
    "When a page lists works under a heading that states their scoring — 'Works for string "
