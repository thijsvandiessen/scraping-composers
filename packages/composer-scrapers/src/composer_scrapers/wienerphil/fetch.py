...
on its way, so fetching those fragments directly *is* the whole source: one
landing page (for the filter vocabularies and the item count) plus eleven result
fragments at the time of writing.
"""
